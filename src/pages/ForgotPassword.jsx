      ...
      <div className='flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto'>
        ...
        <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
          <form>
            ...
            className='mb-6 w-full px-4 py-2 text-xl text-gray-700 bg-white border-gray-300 rounded transition ease-in-out'></input>
            ...
            <div className='flex justify-between whitespace-nowrap text-sm sm:text-lg'>
              ...
              <p>
                <Link className='text-blue-600 hover:text-blue-900 transition duration-200 ease-in-out' to={"/sign-in"}>Sign In</Link>
              </p>
            </div>
            ...
            active:bg-blue-800' type='submit'>Reset password</button>
